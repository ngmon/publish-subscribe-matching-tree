...
import cz.muni.fi.publishsubscribe.matchingtree.adapter.CountingTree;
import cz.muni.fi.publishsubscribe.matchingtree.adapter.Event;
import cz.muni.fi.publishsubscribe.matchingtree.adapter.Operator;
	...
	protected void setUp() throws Exception {
		...
		for (int i = 0; i < PREDICATE_COUNT; i++) {
			Constraint<Long> constraint = new Constraint<Long>(
					LONG_ATTRIBUTE_NAME, new AttributeValue<Long>(number,
							Long.class), Operator.LESS_THAN_OR_EQUAL_TO);
